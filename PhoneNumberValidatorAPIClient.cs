...
namespace APIVerve
{
    public class PhoneNumberValidatorAPIClient
    {
        ...
        public PhoneNumberValidatorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public PhoneNumberValidatorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
