...
namespace APIVerve
{
    public class PhoneValidatorAPIClient
    {
        ...
        public PhoneValidatorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public PhoneValidatorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(phonenumbervalidatorQueryOptions options)
        {
            try
            {
                if (_isDebug)
